...
const checkTesseractVersion = require('./utils')
...
const tesseract = function(image, options, callback) {
  checkTesseractVersion(function(flag) {
    if (!image) throw Error('can not find image')
    if (typeof options !== 'function' && typeof callback !== 'function') throw Error('callback is undefined')
